    ...
    <view class="from">
      ...
      <view class="from-content">
        ...
        <view class="right">
          <view class="radio-list">
            <view class="radios">
              <view class="circle" @tap="payTypeTap(1)"><text class="i" v-if="formData.pay_type === 1"></text></view>对公
            </view>
            <view class="radios">
    ...
    methods: {
      ...
      info () {
        ...
        that.$api.financeInfoApi({id: that.infoId}).then(res => {
          if (res.data.status === 200) {
            that.formData.zc_type = Number(res.data.data.zc_type)
            that.formData.purpose = res.data.data.purpose
            that.formData.order_num = res.data.data.order_num
            that.formData.name_bank = res.data.data.name_bank
            that.formData.pay_address = res.data.data.pay_address
            that.formData.remark = res.data.data.remark
            that.formData.monen = res.data.data.monen
            that.formData.linkman = res.data.data.linkman
            that.formData.tel = res.data.data.tel
            that.formData.pay_name = res.data.data.pay_name
            that.formData.pay_card = res.data.data.pay_card
