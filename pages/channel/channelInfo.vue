<template>
  <view class="fundApplication pageUniapp">
    ...
    <view class="container" :style="{zIndex: 101, transform: `translate${curPage}`, transition: `transform ${showAnimation?turnPageTime:0}s`}" @touchstart="touchStart" @touchend="touchEnd" @touchmove="touchMove" @touchcancel="touchcancel">
      <view class="from">
        <view class="from-content">
          <view class="left">
            商家名称<text class="text"></text>
