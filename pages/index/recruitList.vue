<template>
  <view class="recruitList pageUniapp">
    <view class="pageu">
    <view class="search">
    ...
    <view class="table_list">
      <t-table>
        <t-tr color="#000" fontSize="15">
          <t-th widthStyle="20%">姓名</t-th>
          <t-th widthStyle="31%" paddingLeft="0 0 0 20upx">电话</t-th>
          <t-th widthStyle="38%" textAlign="center">学校</t-th>
          <t-th widthStyle="11%" textAlign="center" paddingLeft="0 0 0 2upx">操作</t-th>
        </t-tr>
        <t-tr v-for="(item, i) in list" :key="i">
          <t-td widthStyle="20%">{{ item.name }}</t-td>
          <t-td widthStyle="31%">{{ item.mobile }}</t-td>
          <t-td widthStyle="38%">{{ item.school }}</t-td>
          <t-td widthStyle="11%">
