  ...
  <view class="fundApplication pageUniapp">
    <view class="from">
      <view class="from-content">
        <view class="left">
          快速填单<text class="text"></text>
        </view>
        <view class="right">
          <input type="text" class="input-style" v-model="cli_name" />
        </view>
        <view class="select-btn" @tap="open">
          查找
        </view>
      </view>
      <view class="from-content">
        ...
        <view class="list-tables" v-for="(item, i) in tableList" :key="i">
          <view class="one">
            <view class="one-left">
              ...
              <view class="right">
                <view class="select-content">
                  <picker class="picker" mode="selector" @change="selectPickerChange($event, i)" :value="item.selectIndex" :range="selectList" range-key="title">
